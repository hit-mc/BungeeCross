package com.keuin.bungeecross.intercommunicate.ingame;
...
public class InGameChatHandlerTest extends TestCase {
    ...
    private InGameChatHandler processor;

    private void initChatProcessor() {
        processor = new InGameChatHandler(
                repeatMessagePrefix,
                inGameCommandPrefix,
                inGameRepeater,
                outboundRepeater,
